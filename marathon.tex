...
$ξ$, $η$, and $λ$ are potentially $b_i$-dependent, and $P$ is a polynomial in
$y_i$, $b_i$, and $x_i$.
...
\begin{equation}\begin{aligned}
        ...
        &= \Exp{c+α\ba_i+β(1-\Exp{-α})\bz_i}\contraction{
                P(y_i, (1-\Exp{-α})\bz_i, x_i)
                \Exp{ξ((1-\Exp{-α})\bz_i) x_i + η((1-\Exp{-α})\bz_i)y_i + λ((1-\Exp{-α})\bz_i)x_i y_i
                +η_iξ_i\bz_i}
        }_{v_i}\\
