...
\begin{definition}[\ac{RVT}]
        \Iac{RVT} is an equivalence class of virtual tangle diagrams subject to
        the following so-called rotational Reidemeister moves:
...
classical link diagram, however, there is not a unique \ac{RVL} diagram.
