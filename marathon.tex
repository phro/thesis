...
Using this vector space isomorphism, all Hopf algebra operations are expressed
as perturbed Gaußians in \cite{BV}. To extend the resulting tangle invariant to
