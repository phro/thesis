...
drawTangleArc((1.75,2)--(1.75,3), doDrawArrow = true);
drawTangleArc((0.25,1)--(0.25,2));
xing((0.25,0), (1,1));
xing((1,1),(1.75,2));
xing((0.25,2),(1,3), doDrawArrow = true);
pair[] dots = {
(0.25,0),
(1   ,0),
(1.75,0),
