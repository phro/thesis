...
% Symbols
        ...
        \ProvideDocumentCommand{\fracOneLine}{mm}
                {\pn{#1}\inv{\pn{#2}}}
...
\DeclarePairedDelimiterX{\signature}[1]{\lvert}{\rvert}{\curry{#1}}
...
\ProvideDocumentCommand{\tangleDown}{m}{\msc T_{#1}}
\ProvideDocumentCommand{\tangle}{m}{\msc T^{\text{up}}_{#1}}
\ProvideDocumentCommand{\tangleMix}{mm}{\overline{\msc T}^{\text{up}}_{#1, #2}}
