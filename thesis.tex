...
In this paper we will extensively use tensor products, and more generally
...
Next, let
$\map {T} {V^{\otimes\set{j_1,\dots,j_s}}} {V^{\otimes\set{i_1,\dots,i_r}}}$ be
a map between tensor powers of $V$. We denote $T$ by
$T^{j_1,\dots,j_s}_{i_1,\dots, i_r}$ (noting the order of the indices matters).
