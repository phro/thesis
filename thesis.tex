...
\subsubsection{Notation extension to monoid objects in general monoidal
categories}
...
clearly, we introduce a notation put forth by Bar-Natan: consider an object
$\MM$ in a monoidal category $\CC$. Then:
\begin{itemize}
