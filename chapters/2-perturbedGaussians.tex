...
\begin{align}
        \Gen*{\mult^{ij}_{k}} &= \label{eq:gen-mult}
        \\ \Gen*{\unit_{i}} &=\label{eq:gen-unit}
        \\\Gen*{\comult^{i}_{jk}} &=\label{eq:gen-comult}
        \\\Gen*{\counit^{i}} &=\label{eq:gen-counit}
        \\\Gen*{\antipode^{i}_{i}} &=\label{eq:gen-antipode}
        \\\Gen*{\Rmat_{ij}} &=\label{eq:gen-Rmat}
        \\\Gen*{\spin_{i}} &=\label{eq:gen-spin}
        \\\Gen*{\ribbon_{i}} &=\label{eq:gen-ribbon}
\end{align}
