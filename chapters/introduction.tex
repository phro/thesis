        ...
        \begin{itemize}
                \item multiplication $\mult^{ij}_{k}[X]$ takes a tangle with
                        ...
                        $k$ (\cref{fig:tangle_mult}).\footnote{Strictly
                                ...
                                See \cref{rem:virtual_caveat} for more details.%
                        }
        ...
        \item We show $\tangle X$ is a meta-algebra:
                \begin{enumerate}
                        ...
                        \item To see that the unit axiom (\cref{eq:cd_unit})
                                ...
                                existing strand does not change any of the
                                combinatorial data, resulting in identical
                                diagrams.
                \end{enumerate}
...
Here we define the ribbon Hopf algebra $\CU = \CUlong[0]$, and point out some of
its properties.
...
\begin{lemma}[Weyl canonical commutation relation]
        Let $ξ, η \in \powerseries{\Q}{\bo}$. Then:
...
\begin{lemma}[Exponential commutation relations in $\CU$]
        ...
        Let $α, η, ξ \in \powerseries{\Q}{\bo}$, and write $\A\defeq \Exp{α}$.
        Then we have
        \begin{align}
