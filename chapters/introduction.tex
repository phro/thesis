...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.2\textwidth]{figures/monodromy.pdf}
        \caption{The monodromy in the meta-Hopf algebra of tangles.}
        \label{fig:monodromy}
\end{figure}
\begin{figure}[h]
        \centering
        \includegraphics[width=0.2\textwidth]{figures/tangle_spin.pdf}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.2\textwidth]{figures/tangle_spini.pdf}
