...
\end{lemma}
\begin{proof}
        We begin by commuting a single $\ao$ past a power of $\yo$:
        \begin{equation}
                \ao y^r
                =\yo(\ao-1)\yo^{r-1}
                =\yo^2(\ao-2)\yo^{r-2}
        ...
        \begin{equation}
                ...
                =\yo^r(\ao-r)^k
        \end{equation}
        Finally, we conclude for any linear combination of powers of $\ao$, the
...
Next, we observe that since $\liebk{\xo}{\yo}$ is central, the Weyl canonical
