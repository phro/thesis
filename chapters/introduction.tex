...
\begin{theorem}[tangles form a ribbon meta-Hopf algebra]
        ...
        \begin{itemize}
                ...
                } This is visualized in \cref{fig:tangle_mult}.
                \item the unit $\unit_{i}[X]$ takes a tangle diagram with
                        strands $X$ and introduces a new strand $i$ which does
                        not touch any of the other strands. This is visualized in \cref{fig:tangle_unit}.
                \item the comultiplication $\comult^{i}_{jk}[X]$ takes a tangle
                        ...
                        represented by (see
                        \cref{fig:tangle_antipode,fig:tangle_spinner} for the
                        resemblance).
                } This is visualized in \cref{fig:tangle_comult}.
                \item the counit $\counit^{i}[X]$ takes a tangle with strands
                        indexed by $X\sqcup \set{i}$ and returns the tangle with
                        strand labelled by $i$ deleted. This is visualized in
                ...
                \item The antipode $\antipode^{i}_{j}[X]$ takes a tangle with
                        ...
                        the letter \enquote{S}. This is visualized in
                        \cref{fig:tangle_antipode}.
                \item the $\Rmat$-matrix $\Rmat_{ij}$ is given by the two-strand
                        ...
                        \emph{negative} crossing of strand $i$ over strand $j$. This is visualized in
                ...
                \item The spinner $\spin_i[X]$ takes a tangle in $\tangle X$ and
                        ...
                        looks like the letter \enquote{C}. This is visualized in
