...
\caption{A ribbon element in the meta-Hopf algebra of tangles.}
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.2\textwidth]{figures/sample.png}% todo: fix
        \caption{The comultiplication $\comult^{i}_{jk}$ doubles a strand in a
        tangle along its framing.}
        \label{fig:tangle_comult}
\end{figure}
\begin{figure}[h]
        \centering
        \includegraphics[width=0.2\textwidth]{figures/sample.png}% todo: fix
        \caption{The $\Rmat$-matrix $\Rmat_{ij}$ and its inverse $\Rmati_{ij}$
                represent tangles with a single crossing}
