...
\begin{align}
        \Rmat_{i,j}
        &\defeq \exp\pn*{\bo_i\ao_j}\exp\pn*{\frac{1-\Bo_i}{\bo_i}\yo_i\xo_j}\\
        \spin &\defeq \sqrt{\Bo}
\end{align}
...
\begin{proof}
        ...
        \end{aligned}
        \end{equation}
        The right two exponentials may be combined since each variable commutes
        with the others, either by belonging to separate tensor factors, or in
        the case of $\bo$, being central.
\end{proof}
