...
of an \defi{algebra}. Then $A_\emptyset$ is a field. It is more common think of
the unit as an element $\one\in V$. The unit map is then defined by linearly
...
\begin{definition}[meta-coalgebra]
        A \defi{meta-colagebra} (or \defi{meta-comonoid}) is a meta-object
