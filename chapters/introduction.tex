...
larger domain and codomain, which we write
$T^{D}_{C}[S] \defeq T^D_C \otimes \Id{S}$. For any $v_D \in V_{D}$ and $w_S\in
V_{S}$, it acts by
$\pn*{T^{D}_{C}[S]}\pn{v_{D}\otimes w_S} = \pn*{T^{D}_{C}v_{D}}\otimes w_S$.
\begin{remark}
