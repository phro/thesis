...
\newcommand{\Wt}{\tilde{W}}
\begin{frame}
        \begin{theorem}[contraction theorem {[Bar-Natan, van der Veen]}]
                In the ring
                $R_n = \powerseries{
                        \polyring{\Q}{r_j, g_j}
...
\begin{frame}
        Choosing a basis for $\CU_{\CU}$ defines an isomorphism with a
        polynomial ring:
        \begin{equation*}
...
\begin{frame}
        To start, we open one component\onslide<2>{, then the other.}
        \begin{figure}[ht]
                \begin{subfigure}[b]{0.4\textwidth}
                        \centering
                        \includegraphics[
